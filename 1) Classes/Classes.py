#Class: Ortak özelliklere sahip nesnelerin bir arada toplanmış halidir. Class'lar bir objedir bu objeler hem bir
# şeyler yaparlar hem de bir şeyleri bilirler.
class Employee:
...
# Class yaratma aşağıdaki gibi yapılır.
employee1 = Employee()